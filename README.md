## Turns any generic IR-controlled LED strip into ambient lights syncing with the monitor's mean color every ~100 milliseconds using a Microcontroller and an IR Transmitter module.
