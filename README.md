...
I first had to record the IR frequencies for each of the buttons my strip's remote has found in IR_codes.md (mine uses the NEC-8 protocol) and map them to an approximate range of RGB based on the actual color the LED outputs.  
